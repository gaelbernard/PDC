...
def get_cluster(feature, k):
    label = AgglomerativeClustering(n_clusters=k, affinity="precomputed", linkage="average").fit_predict(feature)
...
cluster = get_cluster(feature, 5) #8 possible, 10 pas possible, 12 pas possible
