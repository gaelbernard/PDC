...
# Load logs
log = Log()
log.read_csv('/Users/gbernar1/Desktop/pdc_3/PDC_repo/results/log1/1_remove_uncomplete_trace_gael/output/dataset/dataset.csv')
